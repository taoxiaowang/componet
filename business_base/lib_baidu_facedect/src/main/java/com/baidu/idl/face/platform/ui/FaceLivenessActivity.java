...
public class FaceLivenessActivity extends Activity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidu_activity_face_liveness_v3100);
        ...
        mSoundView.setImageResource(mIsEnableSound ?
                R.mipmap.baidu_ic_enable_sound_ext : R.mipmap.baidu_ic_disable_sound_ext);
    ...
    public void onResume() {
        ...
        if (mTipsTopView != null) {
            mTipsTopView.setText(R.string.baidu_detect_face_in);
        }
        startPreview();
    }
    ...
    private void onRefreshTipsView(boolean isAlert, String message) {
        if (isAlert) {
            if (mTipsIcon == null) {
                mTipsIcon = getResources().getDrawable(R.mipmap.baidu_ic_warning);
            ...
            mTipsTopView.setBackgroundResource(R.drawable.baidu_bg_tips);
            mTipsTopView.setText(R.string.baidu_detect_standard);
            mTipsTopView.setCompoundDrawables(mTipsIcon, null, null, null);
        } else {
            mTipsTopView.setBackgroundResource(R.drawable.baidu_bg_tips_no);
