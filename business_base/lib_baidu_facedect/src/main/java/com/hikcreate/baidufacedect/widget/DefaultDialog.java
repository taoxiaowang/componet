 ...
 */
package com.hikcreate.baidufacedect.widget;
...
public class DefaultDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public DefaultDialog create() {
            ...
            final DefaultDialog dialog = new DefaultDialog(context, R.style.baidu_DefaultDialog);
            View layout = inflater.inflate(R.layout.baidu_widget_face_dialog, null);
