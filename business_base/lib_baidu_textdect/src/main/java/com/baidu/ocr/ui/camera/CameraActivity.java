...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baidu_bd_ocr_activity_camera);
        ...
        titleView = (TextView) findViewById(R.id.tv_text_scan_title);
        ...
        findViewById(R.id.ic_capture_back).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void initParams() {
        ...
        title = getIntent().getStringExtra(KEY_CONTENT_TITLE);
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_CAMERA: {
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(getApplicationContext(), R.string.baidu_camera_permission_required, Toast.LENGTH_LONG)
                            .show();
                }
                break;
            }
