...
public class MaskView extends View {
        ...
        switch (maskType) {
            case MASK_TYPE_ID_CARD_FRONT:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(),
                        R.drawable.baidu_bd_ocr_id_card_locator_front, null);
                break;
            case MASK_TYPE_ID_CARD_BACK:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(),
                        R.drawable.baidu_bd_ocr_id_card_locator_back, null);
                break;
            case MASK_TYPE_PASSPORT:
                locatorDrawable = ResourcesCompat.getDrawable(getResources(),
                        R.drawable.baidu_bd_ocr_passport_locator, null);
                break;
    ...
    private void init() {
        locatorDrawable = ResourcesCompat.getDrawable(getResources(), R.drawable.baidu_bd_ocr_id_card_locator_front, null);
    }
