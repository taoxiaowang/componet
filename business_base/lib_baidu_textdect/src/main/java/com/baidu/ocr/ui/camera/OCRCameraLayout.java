...
import com.hikcreate.baidutextdect.R;

public class OCRCameraLayout extends FrameLayout {

    public static int ORIENTATION_PORTRAIT = 0;
    public static int ORIENTATION_HORIZONTAL = 1;
    public static double CAMERA_SCREEN_RATIO = 0.75;
    ...
    private void parseAttrs(AttributeSet attrs) {
        TypedArray a = getContext().getTheme().obtainStyledAttributes(
                attrs,
                R.styleable.baidu_OCRCameraLayout,
                0, 0);
        try {
            contentViewId = a.getResourceId(R.styleable.baidu_OCRCameraLayout_baidu_contentView, -1);
            centerViewId = a.getResourceId(R.styleable.baidu_OCRCameraLayout_baidu_centerView, -1);
            leftDownViewId = a.getResourceId(R.styleable.baidu_OCRCameraLayout_baidu_leftDownView, -1);
            rightUpViewId = a.getResourceId(R.styleable.baidu_OCRCameraLayout_baidu_rightUpView, -1);
        } finally {
            a.recycle();
        }
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        if (r < b) {
            // 特别备注解决胖手机手机bottom放置其他短内容遮挡问题
            int contentHeight = (int) (height * CAMERA_SCREEN_RATIO);
            ...
            int contentWidth = (int) (width * CAMERA_SCREEN_RATIO);
