...
public class CameraView extends FrameLayout {
    ...
    public void setMaskType(@MaskView.MaskType int maskType, final Context ctx) {
        ...
        int hintResourceId = R.drawable.baidu_bd_ocr_hint_align_id_card;
        this.maskType = maskType;
        boolean isNeedSetImage = true;
        switch (maskType) {
            case MaskView.MASK_TYPE_ID_CARD_FRONT:
                hintResourceId = R.drawable.baidu_bd_ocr_round_corner;
            ...
            case MaskView.MASK_TYPE_BANK_CARD:
                hintResourceId = R.drawable.baidu_bd_ocr_hint_align_bank_card;
                break;
...
//        }
        ...
        cameraControl.setCameraInitCallback(status -> {
            if (!status) {
                hintViewText.setText("相机打开失败，请退出重试");
            }
        });
        ...
        hintViewText.setBackgroundResource(R.drawable.baidu_bd_ocr_round_corner);
