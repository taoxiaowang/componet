...
public class Camera1Control implements ICameraControl {
    ...
    private OnCameraInitCallback cameraInitCallback;
    ...
    @Override
    public void setCameraInitCallback(OnCameraInitCallback cameraInitCallback) {
    ...
    public void takePicture(final OnTakePictureCallback onTakePictureCallback) {
        ...
        try {
            Camera.Size picSize = getOptimalSize(getCameraParameters().getSupportedPictureSizes());
    ...
    private void initCamera() {
        try {
            ...
            if (cameraInitCallback != null) {
                cameraInitCallback.onCameraInit(false);
            }
        }
    }
    ...
    private void opPreviewSize(int width, @SuppressWarnings("unused") int height) {
        ...
        if (parameters != null && camera != null && width > 0) {
            optSize = getOptimalSize(getCameraParameters().getSupportedPreviewSizes());
    ...
    private Camera.Parameters getCameraParameters() {
        ...
        try {
            tempParameters = camera.getParameters();
        } catch (RuntimeException e) {
            e.printStackTrace();
